...
# @Date:   02-Oct-2020 08:10:36:362  GMT-0600
# @Email:  rijshouray@gmail.com
# @Filename: specific_cleaning.py
# @Last modified by:   Ray
# @Last modified time: 24-Feb-2021 00:02:00:003  GMT-0700
# @License: [Private IP]
...
df.columns = ['id', 'school_name', 'sex', 'age', 'address', 'family_size', 'parent_status', 'mother_education',
              'father_education', 'mother_job', 'father_job', 'reason_for_school', 'guardian', 'travel_time',
              'study_time', 'class_failures', 'extra_edu_support', 'family_edu_support', 'paid_tutors', 'extra_curic',
              'nursery_school', 'higher_edu_interest', 'internet_access', 'romantic_rel_interest', 'qual_family_rel',
